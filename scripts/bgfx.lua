...
function bgfxProjectBase(_kind, _defines)
	...
	files {
		...
		path.join(MODULE_DIR, "scripts/**.natvis"),
	}
	...
	overridefiles(MODULE_DIR, path.join(MODULE_DIR, "../bgfx-agc"), {
		path.join(MODULE_DIR, "src/renderer_agc.cpp"),
		path.join(MODULE_DIR, "src/renderer_agc.h"),
	})

	overridefiles(MODULE_DIR, path.join(MODULE_DIR, "../bgfx-gnm"), {
		path.join(MODULE_DIR, "src/renderer_gnm.cpp"),
		path.join(MODULE_DIR, "src/renderer_gnm.h"),
	})

	overridefiles(MODULE_DIR, path.join(MODULE_DIR, "../bgfx-nvn"), {
		path.join(MODULE_DIR, "src/renderer_nvn.cpp"),
		path.join(BGFX_MODULE_DIRDIR, "src/renderer_nvn.h"),
	})
	...
	if filesexist(MODULE_DIR, path.join(MODULE_DIR, "../bgfx-gnm"), {
		path.join(MODULE_DIR, "scripts/bgfx.lua"), }) then

		dofile(path.join(MODULE_DIR, "../bgfx-gnm/scripts/bgfx.lua") )
	end

	if filesexist(MODULE_DIR, path.join(MODULE_DIR, "../bgfx-nvn"), {
		path.join(MODULE_DIR, "scripts/bgfx.lua"), }) then

		dofile(path.join(MODULE_DIR, "../bgfx-nvn/scripts/bgfx.lua") )
	end
