...
project "shaderc"
	...
	if filesexist(MODULE_DIR, path.join(MODULE_DIR, "../bgfx-gnm"), {
		path.join(MODULE_DIR, "scripts/shaderc.lua"), }) then

		if filesexist(MODULE_DIR, path.join(MODULE_DIR, "../bgfx-gnm"), {
			path.join(MODULE_DIR, "tools/shaderc/shaderc_pssl.cpp"), }) then

			removefiles {
				path.join(MODULE_DIR, "tools/shaderc/shaderc_pssl.cpp"),
			}
		end

		dofile(path.join(MODULE_DIR, "../bgfx-gnm/scripts/shaderc.lua") )
	end
